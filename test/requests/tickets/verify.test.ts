...
const doRequest = async (ticketCode: string, data: Object = {}, token: string = '') =>
  request(app).post(`/tickets/${ticketCode}/verify`).set('Cookie', `token=${token}`).send(data)

describe('POST /tickets/:code/verify', () => {
